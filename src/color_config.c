...
void init_editor_colors(void) {
    ...
    init_pair(COLOR_PAIR_NORMAL_MODE, NORMAL_MODE_FG_COLOR, NORMAL_MODE_BG_COLOR);
    init_pair(COLOR_PAIR_INSERT_MODE, INSERT_MODE_FG_COLOR, INSERT_MODE_BG_COLOR);
    init_pair(COLOR_PAIR_COMMAND_MODE, COMMAND_MODE_FG_COLOR, COMMAND_MODE_BG_COLOR);
}
